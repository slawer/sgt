...
{
    /// <summary>
    /// Реализует параметр Газ Д1 (CH4) Датчик
    /// </summary>
    public class P0006 : TParameter
    {
        ...
        public P0006(Guid p_identifier)
            : base(p_identifier, "P0006", "Газ Д1 Датчик")
        {
            lower = 20;
            upper = 50;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д1
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д1
        /// </summary>
        public float Upper
        {
            get
