...
{
    /// <summary>
    /// Реализует параметр Объём ДУ13 Датчик
    /// </summary>
    public class P9_12 : TParameter
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="p_identifier">Идентификатор технологического параметра</param>
        public P9_12(Guid p_identifier)
            : base(p_identifier, "P9_12", "Объём ДУ13 Датчик")
        {
        }

        /// <summary>
        /// Вычислить значение технологического параметра Объём ДУ13 Датчик
        /// </summary>
