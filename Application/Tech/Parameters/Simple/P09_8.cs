...
{
    /// <summary>
    /// Реализует параметр Объём ДУ9 Датчик
    /// </summary>
    public class P09_8 : TParameter
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="p_identifier">Идентификатор технологического параметра</param>
        public P09_8(Guid p_identifier)
            : base(p_identifier, "P09_8", "Объём ДУ9 Датчик")
        {
        }

        /// <summary>
        /// Вычислить значение технологического параметра Объём ДУ9 Датчик
        /// </summary>
