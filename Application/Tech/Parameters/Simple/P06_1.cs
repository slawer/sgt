...
{
    /// <summary>
    /// Реализует параметр Газ Д2 (CH4) Датчик
    /// </summary>
    public class P06_1 : TParameter
    {
        ...
        public P06_1(Guid p_identifier)
            : base(p_identifier, "P06_1", "Газ Д2 Датчик")
        {
            lower = 20;
            upper = 50;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д2
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д2
        /// </summary>
        public float Upper
        {
            get
