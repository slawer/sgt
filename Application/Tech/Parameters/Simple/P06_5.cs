...
{
    /// <summary>
    /// Реализует параметр Газ Д6 (H2S) Датчик
    /// </summary>
    public class P06_5 : TParameter
    {
        ...
        public P06_5(Guid p_identifier)
            : base(p_identifier, "P06_5", "Газ Д6 Датчик")
        {
            lower = 8;
            upper = 20;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д6
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д6
        /// </summary>
        public float Upper
        {
            get
