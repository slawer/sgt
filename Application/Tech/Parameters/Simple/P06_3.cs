...
{
    /// <summary>
    /// Реализует параметр Газ Д4 (CH4) Датчик
    /// </summary>
    public class P06_3 : TParameter
    {
        ...
        public P06_3(Guid p_identifier)
            : base(p_identifier, "P06_3", "Газ Д4 Датчик")
        {
            lower = 20;
            upper = 50;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д4
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д4
        /// </summary>
        public float Upper
        {
            get
