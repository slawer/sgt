...
{
    /// <summary>
    /// Реализует параметр Объём ДУ5 Датчик
    /// </summary>
    public class P09_4 : TParameter
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="p_identifier">Идентификатор технологического параметра</param>
        public P09_4(Guid p_identifier)
            : base(p_identifier, "P09_4", "Объём ДУ5 Датчик")
        {
        }

        /// <summary>
        /// Вычислить значение технологического параметра Объём ДУ5 Датчик
        /// </summary>
