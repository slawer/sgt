...
{
    /// <summary>
    /// Реализует параметр Газ Д8 (H2S) Датчик
    /// </summary>
    public class P06_7 : TParameter
    {
        ...
        public P06_7(Guid p_identifier)
            : base(p_identifier, "P06_7", "Газ Д8 Датчик")
        {
            lower = 8;
            upper = 20;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д8
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д8
        /// </summary>
        public float Upper
        {
            get
