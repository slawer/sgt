...
{
    /// <summary>
    /// Реализует параметр Газ Д5 (H2S) Датчик
    /// </summary>
    public class P06_4 : TParameter
    {
        ...
        public P06_4(Guid p_identifier)
            : base(p_identifier, "P06_4", "Газ Д5 Датчик")
        {
            lower = 8;
            upper = 20;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д5
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д5
        /// </summary>
        public float Upper
        {
            get
