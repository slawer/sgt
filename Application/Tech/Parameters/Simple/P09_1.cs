...
{
    /// <summary>
    /// Реализует параметр Объём ДУ2 Датчик
    /// </summary>
    public class P09_1 : TParameter
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="p_identifier">Идентификатор технологического параметра</param>
        public P09_1(Guid p_identifier)
            : base(p_identifier, "P09_1", "Объём ДУ2 Датчик")
        {
        }

        /// <summary>
        /// Вычислить значение технологического параметра Объём ДУ2 Датчик
        /// </summary>
