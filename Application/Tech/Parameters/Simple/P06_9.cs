...
{
    /// <summary>
    /// Реализует параметр Газ Д10 (H2S) Датчик
    /// </summary>
    public class P06_9 : TParameter
    {
        ...
        public P06_9(Guid p_identifier)
            : base(p_identifier, "P06_9", "Газ Д10 Датчик")
        {
            lower = 8;
            upper = 20;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д9
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д9
        /// </summary>
        public float Upper
        {
            get
