...
{
    /// <summary>
    /// Реализует параметр Объём ДУ6 Датчик
    /// </summary>
    public class P09_5 : TParameter
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="p_identifier">Идентификатор технологического параметра</param>
        public P09_5(Guid p_identifier)
            : base(p_identifier, "P09_5", "Объём ДУ6 Датчик")
        {
        }

        /// <summary>
        /// Вычислить значение технологического параметра Объём ДУ6 Датчик
        /// </summary>
