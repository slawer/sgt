...
{
    /// <summary>
    /// Реализует параметр Объём ДУ10 Датчик
    /// </summary>
    public class P09_9 : TParameter
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса
        /// </summary>
        /// <param name="p_identifier">Идентификатор технологического параметра</param>
        public P09_9(Guid p_identifier)
            : base(p_identifier, "P09_9", "Объём ДУ10 Датчик")
        {
        }

        /// <summary>
        /// Вычислить значение технологического параметра Объём ДУ10 Датчик
        /// </summary>
