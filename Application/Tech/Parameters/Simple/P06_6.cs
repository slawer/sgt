...
{
    /// <summary>
    /// Реализует параметр Газ Д7 (H2S) Датчик
    /// </summary>
    public class P06_6 : TParameter
    {
        ...
        public P06_6(Guid p_identifier)
            : base(p_identifier, "P06_6", "Газ Д7 Датчик")
        {
            lower = 8;
            upper = 20;
        }
        ...
        /// <summary>
        /// Определяет нижнюю границу уровня тревоги для параметра Газ Д7
        /// </summary>
        public float Lower
        {
            get
        ...
        /// <summary>
        /// Определяет верхнюю границу уровня тревоги для параметра Газ Д7
        /// </summary>
        public float Upper
        {
            get
