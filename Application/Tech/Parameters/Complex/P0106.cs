...
{
    /// <summary>
    /// Реализует параметр Изменение суммарного объема
    /// </summary>
    public class P0106 : TParameter
    {
        ...
        public P0106(Guid p_identifier)
            : base(p_identifier, "P0106", "Изменение суммарного объема")
        {
            simple = false;
        ...
        public void Calculate(P0104 v1)
        {
            if (slim.TryEnterWriteLock(300))
            {
                try
