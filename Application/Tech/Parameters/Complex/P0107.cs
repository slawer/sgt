...
{
    /// <summary>
    /// Реализует параметр Сигнал тревоги Газы 20%
    /// </summary>
    public class P0107 : TParameter
    {
        ...
        public P0107(Guid p_identifier)
            : base(p_identifier, "P0107", "Сигнал тревоги Газы 20%")
        {
            simple = false;
                                ...
                                P06_6 v7, P06_7 v8, P06_8 v9, P06_9 v10)
        {
            if (slim.TryEnterWriteLock(300))
            {
                try
                {
                    ...
                    float[] lowers = { v1.Lower, v2.Lower, v3.Lower, v4.Lower, v5.Lower, 
                                         v6.Lower, v7.Lower, v8.Lower, v9.Lower, v10.Lower, };

                    if (gases != null && vals != null && lowers != null)
                    {
                        if (gases.Length == vals.Length && gases.Length == lowers.Length)
                        {
                    ...
                    if (Node != null && Node.HasChildNodes)
                    {
                        if (Node.Name == RootName)
                        {
                            ...
                            if (gases != null)
                            {
                                ...
                                {
                                    int gas_number = GetGasNumberFromName(Child.Name, gas_names);
                                    switch (gas_number)
                                    {
