...
namespace SGT
{
    ...
    /// </summary>
    public class P0116 : TParameter
    {
        protected SourceMoving _source;     // источник, который выбирается для вычисления Параметра Ходы Насоса 1 
        ...
        /// <summary>
        /// Определяет источник, который выбирается для вычисления Параметра Ходы Насоса 1 
        /// </summary>
        ...
        /// <summary>
        /// Вычисляет текущее значение Параметр Ходы Насоса 1 
        /// Вычисляется в каждом такте.
        /// </summary>
        /// <param name="v1">Параметр Ходы Насоса 1 с Аналогового сигнала</param>
        /// <param name="v2">Параметр Ходы Насоса 1 АСУ</param>
        public void Calculate(P0008 v1, P0011 v2)
        {
            if (slim.TryEnterWriteLock(300))
            {
                try
        ...
        {
            /// <summary>
            /// Источник аналоговый сигнал
            /// </summary>
            Analog,

            /// <summary>
            /// Источник АСУ Буровой
            /// </summary>
            Asy,
