...
namespace SGT
{
    public partial class CommandP0213Form : Form
    {
        SgtApplication _app = null;
        public CommandP0213Form()
        {
            InitializeComponent();
            _app = SgtApplication.CreateInstance();
        }

        private void CommandP0213Form_Load(object sender, EventArgs e)
        {
            TimeSpan span = new TimeSpan((long)_app.Technology.P0213.ExactTimeCirculation);
        ...
        private void accept_Click(object sender, EventArgs e)
        {
            ...
            if (float.IsNaN(hours) == false && float.IsNaN(minutes) == false)
            {
                ...
                _app.Technology.P0213.Reset(span.Ticks);
            }
            else
            {
